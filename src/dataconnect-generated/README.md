...
The `data` property is an object of type `ListBeachesData`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, listBeaches } from '@dataconnect/generated';
...
import { connectorConfig, listBeachesRef } from '@dataconnect/generated';
...
The `data` property is an object of type `GetBeachDetailsData`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, getBeachDetails, GetBeachDetailsVariables } from '@dataconnect/generated';
...
```typescript
import { getDataConnect, executeQuery } from 'firebase/data-connect';
import { connectorConfig, getBeachDetailsRef, GetBeachDetailsVariables } from '@dataconnect/generated';
...
The `data` property is an object of type `GetCommentsForBeachData`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, getCommentsForBeach, GetCommentsForBeachVariables } from '@dataconnect/generated';
...
```typescript
import { getDataConnect, executeQuery } from 'firebase/data-connect';
import { connectorConfig, getCommentsForBeachRef, GetCommentsForBeachVariables } from '@dataconnect/generated';
...
## CreateBeach
You can execute the `CreateBeach` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [dataconnect-generated/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `CreateBeachData`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, createBeach, CreateBeachVariables } from '@dataconnect/generated';
...
import { connectorConfig, createBeachRef, CreateBeachVariables } from '@dataconnect/generated';
...
## CreateAccess
You can execute the `CreateAccess` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [dataconnect-generated/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `CreateAccessData`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, createAccess, CreateAccessVariables } from '@dataconnect/generated';
...
```typescript
import { getDataConnect, executeMutation } from 'firebase/data-connect';
import { connectorConfig, createAccessRef, CreateAccessVariables } from '@dataconnect/generated';
...
You can execute the `UpdateAccessCuration` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [dataconnect-generated/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `UpdateAccessCurationData`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, updateAccessCuration, UpdateAccessCurationVariables } from '@dataconnect/generated';
...
```typescript
import { getDataConnect, executeMutation } from 'firebase/data-connect';
import { connectorConfig, updateAccessCurationRef, UpdateAccessCurationVariables } from '@dataconnect/generated';
...
## UpdateReportScore
You can execute the `UpdateReportScore` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [dataconnect-generated/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `UpdateReportScoreData`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, updateReportScore, UpdateReportScoreVariables } from '@dataconnect/generated';
...
```typescript
import { getDataConnect, executeMutation } from 'firebase/data-connect';
import { connectorConfig, updateReportScoreRef, UpdateReportScoreVariables } from '@dataconnect/generated';
...
You can execute the `UpdateUserReputation` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [dataconnect-generated/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `UpdateUserReputationData`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, updateUserReputation, UpdateUserReputationVariables } from '@dataconnect/generated';
...
```typescript
import { getDataConnect, executeMutation } from 'firebase/data-connect';
import { connectorConfig, updateUserReputationRef, UpdateUserReputationVariables } from '@dataconnect/generated';
